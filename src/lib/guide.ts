...
export const guideArticles: GuideArticle[] = [
  ...
  { slug: "family-study-where-to-stay", title: "親子留学、住まいはコンドかホームステイか", excerpt: "家族で住む場合の選び方の判断軸。", publishedAt: "2026.04.30", categorySlug: "family", areaSlugs: ["mabolo", "banilad"], gradient: "from-sky-500 to-palm-500", readingMinutes: 7, author: "セブ犬/編集長" },
